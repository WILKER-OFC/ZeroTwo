...
const handler = async (m, { conn, text, command }) => {
  if (!text) return m.reply(`👻 *Aiko bot invocando*
...
🖤 Nada fue encontrado…`)
    ...
    if (isAudio) {
      ...
      await m.reply(`👻 *Aiko bot — Análisis de tu pedido*
...
handler.command = handler.help = ["song", "songaudio", "ytmp3", "song2", "songvid", "songytv", "ytmp4", "songyt"]
