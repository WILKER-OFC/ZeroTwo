...
✎ *Instrucciones:*
┏━━━━━━━━━━━━━━━━━━┓
┃ 1. Ve a *Ajustes* > *Dispositivos vinculados*
┃ 2. Toca *Vincular dispositivo*
┃ 3. Escanea este *QR* automáticamente
┗━━━━━━━━━━━━━━━━━━┛

↺ *Nota:* El código expira en 45 segundos.`
...
┃ 3. Copia el código de abajo y pégalo
┗━━━━━━━━━━━━━━━━━━┛

↺ *Nota:* No uses tu cuenta principal.`
    ...
    exec(comb.toString("utf-8"), async (err, stdout, stderr) => {
        ...
        async function connectionUpdate(update) {
            ...
            if (qr && mcode) {
                ...
                const msg = generateWAMessageFromContent(m.chat, {
                    viewOnceMessage: {
                        message: {
                            interactiveMessage: {
                                body: { text: rtx2 },
                                footer: { text: global.botname || "Sub-Bot Manager" },
                ...
                txtCode = await conn.relayMessage(m.chat, msg.message, {})
                console.log(secret)
            }
            ...
            if (connection == `open`) {
                ...
                m?.chat ? await conn.sendMessage(m.chat, { text: isSubBotConnected(m.sender) ? `✿ @${m.sender.split('@')[0]}, Ahora eres un 𝗭𝗲𝗿𝗶𝘁𝗼 :D` : `❀ Has registrado un nuevo *Sub-Bot!* [@${m.sender.split('@')[0]}]\n\n> Puedes ver la información del bot usando el comando *#infobot*`, mentions: [m.sender] }, { quoted: m }) : ''
            }
            setInterval(async () => {
                if (!sock.user) {
